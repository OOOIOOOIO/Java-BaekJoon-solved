 ...
 *  StringTokenizer로 여러 구분자를 사용 하고 싶다면 구분할 문자들을 합쳐서 넘겨주면 된다. 
 *  
 *  st = new StringTokenizer(Category.문자열, "구분할 것들");
 *  st = new StringTokenizer(br.readLine(), "[],");
 *  
 ...
 *  split("[\\[\\]\\,") 같이 정규식으로만 쓴다면 첫 번째 인자가 정규식에 걸려 빈 문자열을 반환하게 되기 때문
 *  
 *  
 *  ex)
 *  str = "[1,2,3,4]";
